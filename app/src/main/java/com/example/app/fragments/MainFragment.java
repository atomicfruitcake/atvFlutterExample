...
import com.example.app.activities.BrowseErrorActivity;
...
public class MainFragment extends BrowseFragment {
    ...
    private static final int NUM_ROWS = Constants.VIDEO_CATEGORIES.length;
    ...
    private void loadRows() throws InterruptedException, IOException {
        ...
        for (i = 0; i < NUM_ROWS; i++) {
            ...
            for (int j = 0; j < NUM_COLS; j++) {
                listRowAdapter.add(list.get(j % NUM_ROWS));
            }
            HeaderItem header = new HeaderItem(i, Constants.VIDEO_CATEGORIES[i]);
